                ...
                <ul id="main-nav" class="nav nav-tabs nav-stacked">
                    ...
                    <li>
                        ...
                        <ul id="system" class="nav nav-list collapse secondmenu " style="height: 0px;font-size:xx-large">
                            <li><a href="list.do" target="main" >   <i class="glyphicon glyphicon-zoom-in"></i>查看工资</a></li>
                            <li><a href="list.do" target="main" >   <i class="glyphicon glyphicon-edit"></i>修改工资</a></li>
                            <li><a href="listUserEmployee.do" target="main" >   <i class="glyphicon glyphicon-plus-sign"></i>添加工资</a></li>
                        </ul>
        ...
        <div class="col-sm-10" style="width:100%;">
            <div class="panel panel-default">
                ...
                <div class="panel-body" style="height:50px;padding:9px">
                    <form role="form" class="form-inline" action="/Employee/listOneUser.do" method="post">
                        <div class="form-group">
                            <label for="name">工号</label>
                            <input type="text" class="form-control" id="name" placeholder="请输入工号" name="id" style="border-radius: 6px;height:25px;width:180px">
                        </div>
                        <div class="form-group">
                            <button type="submit" style="float:left;width:70px;height:30px;padding:6px;padding-top: 3px;color:white;background:#00bbee;border-radius: 7px;font-size:15px;border:0;margin-left: 8%;text-align: center"><span class="glyphicon glyphicon-search">查询</span></button>
                        </div>
                    </form>
                </div>
            </div>
                ...
                <c:forEach items="${pageInfo.list}" var="user">
                    <tr style="border: 1px solid #dee2e6">
                        ...
                        <td style="text-align: center">
                            <a href="/Employee/toAdd.do?id=${user.id}"><div  style="margin-left:5px;float:left;width:126px;height:30px;padding:6px;color:white;background:orange;border-radius: 7px;font-size:15px;border:0;margin-left: 32%;text-align: center"><span class="glyphicon glyphicon-plus-sign">添加工资记录</span></div></a>
                        </td>
                    </tr>
                </c:forEach>
            </table>
