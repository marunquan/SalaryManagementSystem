        ...
        <div class="col-sm-10" style="width:100%;">
            ...
            <table class="table table-striped" style="border: 1px solid #dee2e6">
                <tr style="border: 1px solid #dee2e6;text-align: center">
                    ...
                    <th width="25%" style="text-align: center">工资范围</th>
                    <th width="25%" style="text-align: center">税率</th>
                    <th width="25%" style="text-align: center">操作</th>
                </tr>
                <c:forEach items="${pageInfo.list}" var="slb">
                    <tr style="border: 1px solid #dee2e6;text-align: center">
                        <td>${slb.id}</td>
                        <td style="text-align: center">${slb.left1}元 — ${slb.right1}元</td>
                        <td style="text-align: center">${slb.sl}</td>
                        <td>
                            <a href="toUpdateSl.do?id=${slb.id}"><div  style="float:left;width:58px;height:30px;padding-top:5px;color:white;background:limegreen;border-radius: 10%;font-size:15px;border:0;margin-left: 37%"><span class="glyphicon glyphicon-edit">修改</span></div></a>                        </td>
                    </tr>
                </c:forEach>
            </table>
            <div class="row">
                        ...
                        <ul class="pagination pagination-sm">
                            ...
                            <c:if test="${pageInfo.hasPreviousPage}">
                                <li class="page-item"><a class="page-link"
                                                         href="listSl.do?page=${pageInfo.pageNum-1}">上一页</a></li>
                            </c:if>
                            ...
                            <c:if test="${pageInfo.hasNextPage}">
                                <li class="page-item"><a class="page-link"
                                                         href="listSl.do?page=${pageInfo.pageNum+1}">下一页</a></li>
                            </c:if>
