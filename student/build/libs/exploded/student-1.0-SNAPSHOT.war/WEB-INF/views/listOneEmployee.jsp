    ...
    <div class="container-fluid">
        ...
        <ul class="nav navbar-nav navbar-right navbar-part1-menu">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu navbar-part1-language">
                    <li>
                        <a>中国站</a>
                    </li>
                    <li>
            ...
            <li>
                <a href="javascript:(0);">备案</a>
            </li>
            <li>
                <a href="javascript:(0);">邮箱</a>
            </li>
            <li>
        ...
        <form class="navbar-form navbar-right">
            ...
            <a href="javascript:(0);" class="btn btn-info btn-md">
        ...
        <div style="margin-left: 10px;margin-right:10px;">
            <div class="rpw">
                <ul id="main-nav" class="nav nav-tabs nav-stacked">
                    <li class="active">
                        <a href="/welcome" target="main">
                            <i class="glyphicon glyphicon-th-large"></i>
                            首页
                        </a>
                    </li>
                    <li>
                        <a href="#systemSetting" class="nav-header collapse" data-toggle="collapase">
                        ...
                        <ul id="systemSetting" class="nav nav-list collapse secondmenu " style="height: 0px;">
                            <li><a href="student/list" target="main"><i class="glyphicon glyphicon-user"></i>学生信息</a></li>
        ...
        <div class="col-sm-10" style="width:100%;">
            <div class="panel panel-default">
                ...
                <div class="panel-body" style="height:50px;padding:9px">
                    <form role="form" class="form-inline" action="/Employee/listOne.do">
                        <div class="form-group">
                            <label for="name">工号</label>
                            <input type="text" class="form-control" id="name" placeholder="请输入工号" name="id" style="border-radius: 10px;height:25px;width:180px">
                        </div>
                        <div class="form-group">
                            <button type="submit" style="float:left;width:70px;height:30px;padding:6px;color:white;background:#00bbee;border-radius: 10%;font-size:15px;border:0;margin-left: 8%;text-align: center"><span class="glyphicon glyphicon-search">查询</span></button>
                        </div>
                    </form>
                </div>
            </div>
            <table class="table table-striped" style="border: 1px solid #dee2e6">
                ...
                <c:forEach items="${pageInfo.list}" var="employee">
                    <tr style="border: 1px solid #dee2e6">
                        ...
                        <td>${employee.date}元</td>
                        <td style="text-align:center">

                            &nbsp;&nbsp;&nbsp;<a href="toUpdate.do?id=${employee.id}"><div  style="float:left;width:58px;height:30px;padding-top:5px;color:white;background:limegreen;border-radius: 10%;font-size:15px;border:0;margin-left: 8%"><span class="glyphicon glyphicon-edit">修改</span></div></a>
                        </td>
                    </tr>
                </c:forEach>
            </table>
