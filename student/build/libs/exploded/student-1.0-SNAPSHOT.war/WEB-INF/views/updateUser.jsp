                ...
                <ul id="main-nav" class="nav nav-tabs nav-stacked">
                    ...
                    <li>
                        ...
                        <ul id="system" class="nav nav-list collapse secondmenu " style="height: 0px;">
                            <li><a href="/User/update.do" target="main" >   <i class="glyphicon glyphicon-edit"></i>修改密码</a></li>
                        </ul>
            ...
            <div class="panel panel-default">
                <div class="panel-heading" style="height:40px;padding:5px" >
                    <ol class="breadcrumb">
                        ...
                        <li class="active">修改员工基本信息
                        </li>
                    </ol>
                </div><br>
                <div class="panel-body" style="padding:9px;">
                    <form:form action="update.do" method="post"  enctype="multipart/form-data">

                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;工号 <input name="id"  class="form-control1" type="text" value="${user.id}" readonly><br><br>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;姓名 <input name="name"  class="form-control1" type="text" value="${user.name}"><br><br>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;性别 <input name="sex"  class="form-control1" type="text" value="${user.sex}"><br><br>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;用户名 <input name="username"  class="form-control1" type="text" value="${user.username}"><br><br>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;密码 <input name="password"  class="form-control1" type="text" value="${user.password}"><br><br>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;生日 <input name="birth"  class="form-control1" type="text" value="${user.birth}"><br><br>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;部门 <input name="dept"  class="form-control1" type="text" value="${user.dept}"><br><br>
                            电话号码 <input name="phone"  class="form-control1" type="text" value="${user.phone}"><br><br>
                        ...
                        <div class="form-group" style="float:left;margin-left: 6%">
                            <a href="/User/list.do" ><button type="button" style="float:left;width:68px;height:35px;color:white;background:#00BFFF;border-radius: 10%;font-size:15px;border:0;margin-left: 6%;line-height: 3px"><span class="glyphicon glyphicon-arrow-left">返回</span></button>
                            </a></form><br>
                        </div>
                    </form:form>
                </div>
