            ...
            <div class="panel panel-default">
                <div class="panel-heading" style="height:40px;padding:5px" >
                    <ol class="breadcrumb">
                        ...
                        <li class="active">修改税率
                        </li>
                    </ol>
                </div><br>
                <div class="panel-body" style="padding:9px;">
                    <form:form action="updateSl.do" method="post"  enctype="multipart/form-data">
                        <c:forEach items="${slb}" var="employee">
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;编号 <input name="id"  class="form-control1" type="text" value="${employee.id}" readonly="readonly"><br><br>
                       工资范围 <input name="left1"  class="form-control1" type="text" value="${employee.left1}"  style="width:130px"> 元
                       — <input name="right1"  class="form-control1" type="text" value="${employee.right1}" style="width:130px"> 元<br><br>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;税率 <input name="sl"  class="form-control1" type="text" value="${employee.sl}"><br><br><br>
                        </c:forEach>
                        ...
                        <div class="form-group" style="float:left;margin-left: 6%">
                            <a href="/Employee/listSl.do" ><button  type="button" style="float:left;width:68px;height:35px;color:white;background:#00BFFF;border-radius: 10%;font-size:15px;border:0;margin-left: 6%"><span class="glyphicon glyphicon-arrow-left">返回</span></button>
                            </a></form><br>
                        </div>
                    </form:form>
                </div>
